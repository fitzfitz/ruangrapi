  ...
  return (
    <AppLayout>
      ...
      >
        ...
        {formOptionsQuery.isSuccess && hasFormOptions ? (
          <form
            className="lease-form command-form-card"
          ...
          >
            <div className="form-section">
              <h3>01. Tenant & Unit Context</h3>
              <p className="form-section__helper">
                Select the tenant and the rental unit for this lease agreement.
              </p>
            ...
            <div className="form-section">
              <h3>02. Lease Term & Dates</h3>
              <p className="form-section__helper">
                Define the occupancy start and end dates.
              </p>
            ...
            <div className="form-section">
              <h3>03. Financial Terms</h3>
              <p className="form-section__helper">
                Set monthly rent, deposit amount, and monthly billing day.
              </p>
