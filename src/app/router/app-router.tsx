...
const PaymentsPage = lazy(() =>
  import('../../modules/payments/presentation/payments-page').then(
    (module) => ({
...
const CreatePaymentPage = lazy(() =>
  import('../../modules/payments/presentation/create-payment-page').then(
    (module) => ({
      default: module.CreatePaymentPage,
    }),
  ),
)
const ReceiptDetailPage = lazy(() =>
  import('../../modules/receipts/presentation/receipt-detail-page').then(
    (module) => ({
      default: module.ReceiptDetailPage,
    }),
  ),
)
    ...
    <BrowserRouter>
      ...
      >
        <Routes>
          ...
          />
          <Route
            path={routePaths.dashboardPaymentsNew}
            element={
              <RouteAccessGate route="dashboard">
                <CreatePaymentPage />
              </RouteAccessGate>
          ...
          />
          <Route
            path={routePaths.dashboardReceipts}
            element={
              <RouteAccessGate route="dashboard">
                <ReceiptsPage />
              </RouteAccessGate>
